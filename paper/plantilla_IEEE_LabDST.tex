...
\end{itemize}
Citation example: citing a source \cite{quinonez2022mediapipe}. To cite
several sources at once: \cite{innovatiana2026mediapipe,opencv2026library}.
...
Recent advances in real-time computer vision and pose tracking leverage lightweight deep learning frameworks. Qui{\~n}onez \textit{et al.}~\cite{quinonez2022mediapipe} demonstrated the application of Machine Learning solutions with MediaPipe for real-time landmark estimation. Technical tutorials and implementations using MediaPipe 101~\cite{innovatiana2026mediapipe} and OpenCV~\cite{opencv2026library} provide foundational structures for real-time object detection and feature extraction~\cite{omes2026deteccion}. Building upon these computer vision solutions, this work integrates 21-point hand tracking and body pose estimation directly into the kinematic control of the SOFIA active surface system.
