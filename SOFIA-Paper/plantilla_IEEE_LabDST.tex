...
\begin{figure}[!t]
    ...
    \subfloat[Frame $t_1$: Target entry.]{
    ...
    \subfloat[Frame $t_2$: Tracking initiation.]{
        \begin{minipage}[t]{0.47\linewidth}
            \centering
            \includegraphics[
            width=\linewidth,
    ...
    \subfloat[Frame $t_3$: Intermediate convergence.]{
        \begin{minipage}[t]{0.47\linewidth}
            \centering
            \includegraphics[width=\linewidth]{figures/fig_sim_3}
        \end{minipage}
    }\hfill
\subfloat[Frame $t_4$: Peak coordinated deflection.]{
    \begin{minipage}[t]{0.47\linewidth}
        \centering
        \includegraphics[
            width=\linewidth,
    ...
    \subfloat[Frame $t_5$: Trajectory transit.]{
        \begin{minipage}[t]{0.47\linewidth}
            \centering
            \includegraphics[
	width=\linewidth,
    ...
    \subfloat[Frame $t_6$: Final target alignment.]{
        \begin{minipage}[t]{0.47\linewidth}
            \centering
              \includegraphics[
	width=\linewidth,
